 ...
 * @brief recorre la lista,y recibe un puntero a funcion. Alli, asigna valores al azar en dicha funcion.
 *
 * @param this puntero a la lista de paises LinkedList*.
 * @param pFunc puntero a funcion, recibe una funcion void.
 * @return this(lista de paises).
 */
